...
<script type="text/javascript">
	...
	function doDeal(id) {
		document.forms[0].action = "${basePath}nsfw/complain_dealUI.action?complain.compId="+id;
		document.forms[0].submit();
	}
        ...
        <div class="p_d_1_1">
            <div class="content_info">
                ...
                <div class="search_art">
                    ...
                    <li>
                    	状态：<s:select name="complain.state" list="#complainStateMap" headerKey="" headerValue="请选择状态"/> 
                    </li>
