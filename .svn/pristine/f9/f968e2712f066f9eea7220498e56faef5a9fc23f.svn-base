            ...
            <table width="98%" border="0" align="center">
               ...
               <s:iterator value="#infoList">
                    ...
                    <td height="23">
                  	...
                  	<s:a href="%{#infoViewURL}" target="_blank"><s:property value="title"/></s:a>
                    </td>
        ...
        <div class="lc_grzx1">
            <div class="lc_grzxbt">
                ...
                <div style="float:right;padding-top:3px;">
                	<s:a action="home_complainAddUI" target="_blank" namespace="/sys">我要投诉</s:a>&nbsp;&nbsp;
                </div>
            </div>
            <table width="98%" border="0" align="center">
                ...
                <s:iterator value="complainList">
                	<tr>
                    <td height="23">
                    <s:url var="compViewURL" action="home_complainViewUI" namespace="/sys">
                  		<s:param name="comp.compId"><s:property value="compId"/></s:param>
                  	</s:url>
                  	<s:a href="%{#compViewURL}" target="_blank"><s:property value="compTitle"/></s:a>
                    </td>
                    <td width="180px"><s:property value="#complainStateMap[state]"/></td>
                    <td width="180px"><s:property value="isNm?'匿名投诉':'费匿名投诉'"/></td>
